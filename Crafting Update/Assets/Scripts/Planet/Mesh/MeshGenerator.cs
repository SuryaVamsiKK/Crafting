...
public class MeshGenerator : MonoBehaviour
{
    ...
    //[HideInInspector] public List<int> spwanAblepoints = new List<int>();
    //[HideInInspector] public List<Vector3> spwanablePosition = new List<Vector3>();
    //[HideInInspector] public List<int> biometype = new List<int>();
    //[HideInInspector] public List<float> elevationValues = new List<float>();
